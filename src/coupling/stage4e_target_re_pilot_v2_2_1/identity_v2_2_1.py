"""Frozen identities and runtime paths for Stage 4E-B2-A-v2.2.1."""
...
V2_2_RUN_ID = "20260815T233000000Z_stage4e_b2_a_v2_2_convergence"
V2_2_RESULTS = PROJECT / "results" / "10_stage4e_target_re_pilot_v2_2" / V2_2_RUN_ID
V2_2_CASES = PROJECT / "cases" / "openfoam" / "stage4e_target_re_fixed_cylinder_v2_2" / V2_2_RUN_ID
V2_2_RUNTIME = PROJECT / "runtime" / "stage4e_b2_a_v2_2" / V2_2_RUN_ID
...
def finite(value: Any) -> Any:
    ...
    if isinstance(value, float) and not math.isfinite(value):
        raise ValueError("NaN/Inf is not allowed in v2.2.1 evidence")
    return value
