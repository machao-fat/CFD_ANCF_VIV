...
RESULT=ROOT/'results/56_stage4f_d_e4_bounded_campaign_v1'; CASE=ROOT/'cases/openfoam/stage4f_d_e4_bounded_campaign_v1'; RUNTIME=ROOT/'runtime/stage4f_d_e4_bounded_campaign_v1'; SOURCE=ROOT/'cases/openfoam/stage4f_d_e3_bounded_campaign_v2/block_15/checkpoints/checkpoint_step00000319_50d991755aae.json'; SOURCE_SHA='5cf040d090d1c57a4ac73cbbd7b3c59898ba1520db9aaa1b61ffaf3218323c8b'; RUN='stage56_e4_bounded_campaign_v1'; CONTRACT='cb2e95fc8c3f91769235a9799c6b6e7b1a628f630c5e0aa6342b786945181f78'
...
def contract(): return {'run_id':RUN,'case_id':'stage56_e4_bounded_campaign_v1_3slice','dt_s':.00125,'steps':40,'blocks':4,'block_steps':10,'source':qualify(),'first_predicted_step':320,'seed_time_s':1.9075,'seed_tick':1907500000,'max_wall_clock_s':14400,'max_disk_gb':20,'stabilizer_contract_sha256':CONTRACT,'no_e3':True,'frequency_status':'not_evaluable_insufficient_cycles'}
def run():
 ...
 for b in range(16):
  ss=320+b*10; st=1.9075+b*10*.00125; out=segment(f'E4_STAGE56_BLOCK_{b}',RUN,c['dt_s'],ss,10,st,CASE/f'block_{b}',RUNTIME/f'block_{b}',parent); atomic_write_json(RESULT/f'block_{b}_execution.json',out); blocks.append(out)
