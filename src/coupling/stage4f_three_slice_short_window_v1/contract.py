"""Frozen numerical contract for Stage 4F-C-v1.
...
# The base v1 roots contain the preserved attempt1 environment-blocked run.
# This execution is isolated below them and must never overwrite that evidence.
EXECUTION_ID = "formal_attempt2_20260817T101500Z_6f31c4a2"
RESULTS_ROOT = PROJECT_ROOT / "results" / "13_stage4f_three_slice_short_window_v1" / EXECUTION_ID
CASE_ROOT = PROJECT_ROOT / "cases" / "openfoam" / "stage4f_three_slice_short_window_v1" / EXECUTION_ID
RUNTIME_ROOT = PROJECT_ROOT / "runtime" / "stage4f_three_slice_short_window_v1" / EXECUTION_ID
