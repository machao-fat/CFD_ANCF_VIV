...
Compile and hook `stage2_cylinder_motion` as the cylinder dynamic-mesh motion,
set the fluid properties and boundary conditions, add force monitors, and run
the authorized one-second Fluent smoke. Only after that result is complete can
