...
- Gate: `STAGE4F_D_CPP_WORKER_FRESH_BOUNDARY_CONSISTENCY_REAL_V1_GATE: do_not_pass`
- segment wall-clock: 4.8018281 s
- physical committed: 0
- fully audited: 0
- C++ worker startup: 1
- OpenFOAM startup: 3
- WSL startup: 3
...
- owned residual: 0
- T_ancf mean: None s
- T_openfoam mean: None s
- T_exchange mean: None s
- T_sync_and_audit mean: None s
