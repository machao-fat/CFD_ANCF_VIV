...
- Wall-clock launch cost [s]: explicit `7.954000000027008`, implicit `3.7810000000172295` (the latter is incomplete after one committed window).
...
- Generalized Force V2: explicit `{'status': 'PASS', 'max_threshold_utilization': 0.03671232204816031, 'attempt_count': 10}`; implicit `{'status': 'PASS', 'max_threshold_utilization': 0.03559197967977198, 'attempt_count': 2}`. Committed-window Newton: explicit `{'status': 'PASS', 'committed_record_count': 20}`; implicit `{'status': 'PASS', 'committed_record_count': 2}`.
