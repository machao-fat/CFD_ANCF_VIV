function report = run_stage3_matlab_regression_v8()
%RUN_STAGE3 MATLAB-side v8 regression; this is a fresh v8 execution.
...
report = struct('schema_version','stage3_v8_matlab_regression', ...
    'status','matlab_regression_completed', 'executed_in_v8',true, ...
    'inherited_from_v7',false, 'execution_timestamp',char(datetime('now','TimeZone','UTC')), ...
...
fid = fopen(fullfile(out_dir,'stage3_v8_matlab_test_results.json'),'w');
