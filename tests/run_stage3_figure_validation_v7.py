"""Persist the strict Nature-figure source validation result for v7."""
...
OUT = ROOT / "results" / "04_continuous_fsi" / "stage3_v7_figure_validation.json"
VALIDATOR = Path(r"C:\Users\Administrator\.codex\skills\nature-figure\scripts\validate_figure.py")


def main() -> None:
    completed = subprocess.run([sys.executable, str(VALIDATOR), str(ROOT / "tests" / "plot_stage3_v7.py"), "--json", "--strict"], cwd=ROOT, capture_output=True, text=True, encoding="utf-8", errors="replace")
    try:
