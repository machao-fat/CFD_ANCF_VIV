"""Fresh t=0 40-step real launch using the potential-flow templates.
...
RESULTS = PROJECT / "results/254_cpp_worker_fresh_potential_real_v1"
DOCS = PROJECT / "docs/254_cpp_worker_fresh_potential_real_v1"
PREFLIGHT_AUDIT = PROJECT / "results/254_cpp_worker_fresh_potential_real_preflight_v1/fresh_t0_real_launch_preflight.json"
