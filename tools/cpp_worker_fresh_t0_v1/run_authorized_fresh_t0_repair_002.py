"""Fresh t=0 40-step real launch using the repaired OpenFOAM templates."""
...
RUN_ID = "cpp_worker_fresh_t0_real_006"
CASE_ID = "cpp_worker_fresh_t0_real_case_006"
TEMPLATE_ROOT = PROJECT / "cases/openfoam/stage4f_d_fresh_initialization_v3/run_20260827_meshfix6/cases"
RUNTIME = PROJECT / "runtime/cpp_worker_fresh_t0_v1/real_run_006"
RESULTS = PROJECT / "results/251_cpp_worker_fresh_t0_real_v1"
DOCS = PROJECT / "docs/251_cpp_worker_fresh_t0_real_v1"
PREFLIGHT_AUDIT = PROJECT / "results/248_cpp_worker_fresh_t0_repair_preflight_v1/fresh_t0_real_launch_preflight.json"
...
# Keep the exact fresh t=0 identity and the same immutable worker/library.
...
prior.confirm.GATE_ID = "STAGE4F_D_CPP_WORKER_FRESH_T0_REPAIR_V1_GATE"
prior.confirm.GATE_FILENAME = "stage4f_d_cpp_worker_fresh_t0_repair_v1_gate.json"
