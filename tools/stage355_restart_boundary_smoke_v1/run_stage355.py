"""Run exactly one authorized restart-boundary smoke and fail closed."""
...
# Stage354 is a fresh, offline-prepared candidate. Failed Stage351-353 paths
# are deliberately not reused, and no continuation is configured here.
impl.SOURCE_RUNTIME = ROOT / "runtime/stage354_restart_boundary_v1_fresh_candidate"
...
impl.SMOKE_RUNTIME = ROOT / "runtime/stage355_restart_boundary_smoke_v1"
impl.SMOKE_RESULTS = ROOT / "results/355_restart_boundary_smoke_v1"
impl.CONT_RUNTIME = ROOT / "runtime/stage355_continuation_forbidden"
impl.CONT_RESULTS = ROOT / "results/355_continuation_forbidden"
...
impl.SMOKE_RUN_ID = "run355_restart_boundary_smoke_v1"
impl.SMOKE_CASE_ID = "case355_restart_boundary_smoke_v1"
impl.CONT_RUN_ID = "run355_continuation_forbidden"
impl.CONT_CASE_ID = "case355_continuation_forbidden"
...
def main() -> int:
    ...
    decision = {
        ...
        "stage354_source_runtime": str(impl.SOURCE_RUNTIME),
    }
    (impl.SMOKE_RESULTS / "chain_decision.json").write_text(
