...
RUNTIME = ROOT / "runtime" / "shiels_s5_k988_single_slice_free_fsi_long_development_resume_v1_run_001"
RESULTS = ROOT / "results" / "shiels_s5_k988_single_slice_free_fsi_long_development_resume_v1_run_001"
...
PARTICIPANT = ROOT / "tools" / "shiels_s5_k988_single_slice_free_fsi_long_development_resume_v1" / "sdof_precice_continuation_participant.py"
...
def prepare() -> None:
    ...
    contract = {
        "schema_version": "shiels-s5-k988-single-slice-free-fsi-long-development-resume-v1",
...
def audit() -> dict[str, Any]:
    ...
    result = {"schema_version": "shiels-s5-k988-single-slice-free-fsi-long-development-resume-v1-result", "status": "PASS" if all(hard.values()) else "FAIL_CLOSED",
