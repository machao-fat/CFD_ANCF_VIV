"""Validate the preCICE participant lifecycle using only a deterministic mock backend."""
...
RESULTS = ROOT / "results" / "270_precice_participant_contract_v1"
...
def main() -> int:
    ...
    (RESULTS / "stage4f_d_precice_participant_contract_v1_gate.json").write_text(json.dumps(gate, ensure_ascii=False, indent=2) + "\n", encoding="utf-8")
