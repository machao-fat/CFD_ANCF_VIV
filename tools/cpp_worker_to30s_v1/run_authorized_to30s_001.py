"""Run the explicitly authorized sparse-retention continuation from 6.0 to 30.0 s.

The Stage214 source is immutable. A failure is terminal for this fresh
runtime and any later diagnosis must begin from that preserved source again.
"""
...
RUN_ID = "cpp_worker_to30s_001"
CASE_ID = "cpp_worker_to30s_case_001"
SOURCE_STEP = 3593
SOURCE_TIME_S = 6.0
...
RUNTIME = PROJECT / "runtime/cpp_worker_to30s_v1/to30s_001"
RESULTS = PROJECT / "results/215_cpp_worker_to30s_v1"
DOCS = PROJECT / "docs/215_cpp_worker_to30s_v1"
...
confirm.GATE_ID = "STAGE4F_D_CPP_WORKER_TO30S_V1_GATE"
confirm.GATE_FILENAME = "stage4f_d_cpp_worker_to30s_v1_gate.json"
